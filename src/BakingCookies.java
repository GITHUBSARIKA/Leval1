// Copyright Wintriss Technical Schools 2017

public class BakingCookies {
	public static void main(String[] args) {
		CookieType cookietype = new CookieType(CookieType.CHOCO_CHIP);
		Oven oven = new Oven();
		oven.turnOn();
		MixingBowl mixingbowl = new MixingBowl();
		mixingbowl.addFlour();
		mixingbowl.addButter();
		mixingbowl.addSugar();
		mixingbowl.mixIngredients();
		oven.putBatterInOven();
		mixingbowl.eatCookie(cookietype, mixingbowl, oven);
